...
////////////////////////////////////////////////////////
int GRgivenNum[8]={0,0,0,0,0,0,0,0};
int GRexploreStep=0;
int GRjunctionPassed=0;
////////////////////////////////////////////////////////
...
void GRsettleLine(){
  ...
  GridError = -200*inputVal[0]-100*inputVal[1]-50*inputVal[2]-10*inputVal[3]-5*inputVal[4]+5*inputVal[7]+10*inputVal[8]+50*inputVal[9]+100*inputVal[10]+200*inputVal[11];
...
void GRexploreGrid(){
    ...
    if(GRexploreStep==1){
      readLineSensors();
      MZreadLFSsensors();
      if((MZmode=='c')||(MZmode=='r')||(MZmode=='l')){
        MZmotorStop();

        //read sonar sensors to detect wether the box is present or not
        delay(1000);
        go(140,160);
        go(140,160);
        //go(140,160);
        GRjunctionPassed=GRjunctionPassed+1;
        if (GRjunctionPassed>1){
          GRexploreStep=2;
          GRjunctionPassed=0;
        }
    ...
    if (GRexploreStep==2){
      ...
      GRexploreStep=3;//updated for next steps
    ...
    if (GRexploreStep==4){
      ...
      GRexploreStep=5;//updated for next steps
     ...
     if (GRexploreStep==6){
      ...
      GRexploreStep=7;//updated for next steps
    ...
    if(GRexploreStep==7){
     ...
     if (GRexploreStep==8){
      ...
      GRexploreStep=9;//updated for next steps
    ...
    if (GRexploreStep==10){
      ...
      GRexploreStep=11;//updated for next steps
...
void loop(){
  ...
  oled.println(HelpingStage); // text to display
  oled.display(); 
