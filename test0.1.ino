...
void readLFSsensors()
{
  ...
  else if(((inputVal[0]==0)&&(inputVal[1]==0)&&(inputVal[10]==1)&&(inputVal[11]==1))&&((inputVal[3]==1)||(inputVal[4]==1)||(inputVal[5]==1)||(inputVal[6]==1)||(inputVal[7]==1)||(inputVal[8]==1))){
    mode = 'l';//Right line Turn (w r t robot)
  }
  else if(((inputVal[0]==1)&&(inputVal[1]==1)&&(inputVal[10]==0)&&(inputVal[11]==0))&&((inputVal[3]==1)||(inputVal[4]==1)||(inputVal[5]==1)||(inputVal[6]==1)||(inputVal[7]==1)||(inputVal[8]==1))){
       ...
       if (mode=='n')
        {   
          ...
          if(mode!='c'){
            ...
            {goAndTurn (90);motorStop();delay(100);settleLine(); recIntersection('R');} // or it is a "T" or "Cross"). In both cases, goes to LEFT
          }
            else mazeEnd();} 
            ...
            if (mode == 'n') {goAndTurn (270);motorStop();delay(500);settleLine(); recIntersection('L');}
