...
String FindColorFloor(){
  ...
  else if (((r>1400)&&(r<1700))&&((g >900)&&(g<1150))&&((b<650)&&(b>450)))
  {
    Serial.println("F Colour Blue");
    color = "Colour Blue";
  }

  else if (((r>450)&&(r<560))&&((g>1350)&&(g<1500))&&((b>950)&&(b<1110)))
  {
    Serial.println("F Colour Red");
    color = "Colour Red";
  }
    else if (((r>1250)&&(r<1500))&&((g>750)&&(g<900))&&((b>950)&&(b<1200)))
  {
   ...
   oled.print("  ");
    ...
    if(ultrasonic_distance[1]>ultrasonic_distance[2]){
      ...
      if(distance5<distance6){
        ...
        right_motor_speed=130-PID_ErrorD;
        if (left_motor_speed>=MAX_SPEED){
            left_motor_speed=MAX_SPEED;
        }
        if (right_motor_speed>=MAX_SPEED){
    ...
    //     // }
        ...
        right_motor_speed=130-PID_ErrorD1;
        if (left_motor_speed>=MAX_SPEED){
            left_motor_speed=MAX_SPEED;
        }
        if (right_motor_speed>=MAX_SPEED){
